...
//		b.	Call the method on two arrays with different sizes filled with random numbers
		int[] a = randIntsOfSize(75),b = randIntsOfSize(50);
		PrintArray(a);
		out.println(SumArray(a));
		PrintArray(b);
		out.println(SumArray(b));
	}
...
//		b.	Call the method on two arrays with different sizes filled with random numbers
		int[] a = randIntsOfSize(50), b = randIntsOfSize(9);
		PrintArray(a);
