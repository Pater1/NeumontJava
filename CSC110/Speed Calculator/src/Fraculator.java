...
public class Fraculator {
	...
	private static Fraction MathMenu() throws IOException{
		...
		Fraction A = Fraction.ToSimplestForm(Fraction._userFract()), B = Fraction.ToSimplestForm(Fraction._userFract()), outFract = Fraction._newFract(0, 0, 0);
		String function = "";
		switch(i){
			case 1:
	...
	private static class Fraction {
		...
		public static Fraction divideFractions(Fraction A, Fraction B){
			double l, t, b;
			l = 0;
			b = A.bottom * (B.top + B.leadInt*B.bottom);
			t = (A.top + A.leadInt*A.bottom) * B.bottom;
			return Fraction.ToSimplestForm(Fraction.MakeProper(Fraction._newFract(0, t, b)));
		}
	}
}
